...
namespace WebApiBase.Service.FuncionarioService
{
    public class FuncionarioService : IFuncionarioInterface
    {
        private readonly ApplicationDbContext _context;
        public FuncionarioService(ApplicationDbContext context)// injeção de dependencias
        {
            _context = context;
        }
        public async Task<ServiceResponse<List<FuncionarioModel>>> CreateFuncionario(FuncionarioModel novoFuncionario)
        {
            ...
            try
            {
                ...
                serviceResponse.Dados = _context.Funcionarios.ToList();// retorna um alista
        ...
        public async Task<ServiceResponse<FuncionarioModel>> GetFuncioanrioById(int id)
        {
